...
export const ProfilePage = () => {
	...
	return (
		<Grid container alignItems="flex-start" justifyContent="space-between">
			<SEO title={`ThueNhanh  - ${user.name || user.username || 'Your information'}`} />
			...
			>
				...
				<Grid container spacing={3}>
					<ProfilePage.InputFeild name={t('USER.City')} defaultValue="TP HCM" />
					<ProfilePage.InputFeild name={t('USER.Street_address')} defaultValue="Pham Van Dong" />
					<ProfilePage.InputFeild name={t('USER.Email_address')} defaultValue="locser.02@gmail.com" />
					<ProfilePage.InputFeild name={t('USER.Date_Of_Birth')} defaultValue="28/03/2001" />
					<ProfilePage.InputFeild name={t('USER.Gender')} defaultValue="Male" />
					<ProfilePage.InputFeild name={t('USER.ID_Number')} defaultValue="123456789" />
				</Grid>
